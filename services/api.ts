...
export const apiService = {
  ...
  async getNarratives(params?: {
    ...
    text?: string;
    language?: string;
    spread_level?: NarrativeSpreadLevel[];
    sort?: string;
    ...
    try {
      ...
      // spread_level is a repeatable query parameter: ?spread_level=viral&spread_level=alert
      if (params?.spread_level && params.spread_level.length > 0) {
        query.spread_level = params.spread_level;
      }
